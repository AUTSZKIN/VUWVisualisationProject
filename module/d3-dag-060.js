...
function buildOperator(idOp, parentIdsOp, parentDataOp) {
  function stratify(data) {
    ...
    const nodes = data.map(
      (datum, i) => new LayoutDagNode(verifyId(idOp(datum, i)), datum)
    );
...
export {
  DummyNode$1 as ArqDummyNode,
  DummyNode as SugiDummyNode,
  spread as arqcoordSpread,
  arquint,
  adjacent as columnAdjacent,
  center$1 as columnCenter,
  ...
  quad as coordQuad,
  topological$1 as coordTopological,
  quad as coordVert,
