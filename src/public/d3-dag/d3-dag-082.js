    ...
    Denque2.prototype.splice = function splice(index, count) {
      ...
      if (arguments.length > 2) {
        ...
        if (!size || i < size / 2) {
          ...
          for (k = 0; k < leng; k++) {
            temp[k] =
              this._list[(this._head + i + count + k) & this._capacityMask];
          }
          if (count === 0) {
            removed = [];
            if (i != size) {
          ...
          if (typeof lookup[y] !== "undefined") {
            for (var z in model.variables) {
              if (typeof model.variables[z][xx] !== "undefined") {
                output +=
                  " " + model.variables[z][xx] + " " + z.replace(rxClean, "_");
              }
            }
...
function buildConnect(operators) {
  ...
  function sourceId(id) {
    if (id === void 0) {
      ...
      const { sourceId: _ } = operators,
        rest = __rest(operators, ["sourceId"]);
      return buildConnect(
        Object.assign(Object.assign({}, rest), { sourceId: id })
      );
    }
  }
  ...
  function targetId(id) {
    if (id === void 0) {
      ...
      const { targetId: _ } = operators,
        rest = __rest(operators, ["targetId"]);
      return buildConnect(
        Object.assign(Object.assign({}, rest), { targetId: id })
      );
    }
  }
  ...
  function single(val) {
    if (val === void 0) {
      ...
      return buildConnect(
        Object.assign(Object.assign({}, operators), { single: val })
      );
    }
  }
...
function connect(...args) {
  if (args.length) {
    throw new Error(
      `got arguments to connect(${args}), but constructor takes no aruguments. These were probably meant as data which should be called as connect()(...)`
    );
  } else {
    return buildConnect({
...
function buildHierarchy(operators) {
  function hierarchy2(...data) {
    ...
    const froots =
      rootSet.size && rootSet.size !== roots2.length ? [...rootSet] : roots2;
    verifyDag(froots);
  ...
  function roots(val) {
    if (val === void 0) {
      ...
      return buildHierarchy(
        Object.assign(Object.assign({}, operators), { roots: val })
      );
    }
  }
...
function hierarchy(...args) {
  if (args.length) {
    throw new Error(
      `got arguments to hierarchy(${args}), but constructor takes no aruguments. These were probably meant as data which should be called as hierarchy()(...)`
    );
  } else {
    return buildHierarchy({
...
function buildStratify(operators) {
  ...
  function id(op) {
    if (op === void 0) {
      ...
      const { id: _ } = operators,
        rest = __rest(operators, ["id"]);
  ...
  function parentData(data) {
    if (data === void 0) {
      ...
      const { parentIds: _, parentData: __ } = operators,
        rest = __rest(operators, ["parentIds", "parentData"]);
...
function stratify(...args) {
  if (args.length) {
    throw new Error(
      `got arguments to stratify(${args}), but constructor takes no aruguments. These were probably meant as data which should be called as stratify()(...)`
    );
  } else {
    return buildStratify({
      id: defaultId,
...
function sugify(dag) {
  const cache = new Map(
    dag.idescendants().map((node) => [node, { node, layer: vlayer(node) }])
  );
...
function qp(Q, c, A, b, meq) {
  ...
  bvec.push(...b.map((v) => -v));
  const { solution, message } = (0, import_quadprog.solveQP)(
    Dmat,
    dvec,
    Amat,
    bvec,
...
function buildOperator2(options) {
  function simplexCall(dag) {
    ...
    const _a = import_javascript_lp_solver.Solve.call(
      ...
      { feasible } = _a,
      assignment = __rest2(_a, ["feasible"]);
    if (!feasible) {
  ...
  function rank(newRank) {
    if (newRank === void 0) {
      ...
      const { rank: _ } = options,
        rest = __rest2(options, ["rank"]);
      return buildOperator2(
  ...
  function group(newGroup) {
    if (newGroup === void 0) {
      ...
      const { group: _ } = options,
        rest = __rest2(options, ["group"]);
      return buildOperator2(
        Object.assign(Object.assign({}, rest), { group: newGroup })
      );
    }
  }
...
function buildOperator3({ factory }) {
  function aggCall(topLayer, bottomLayer, topDown) {
    if (topDown) {
      ...
      const aggs = new Map(
        [...incr.entries()].map(([node, agg2]) => [node, agg2.val()])
      );
...
function buildOperator4(options) {
  ...
  function order2(ord) {
    if (ord === void 0) {
      ...
      const { order: _ } = options,
        rest = __rest3(options, ["order"]);
      return buildOperator4(
        Object.assign(Object.assign({}, rest), { order: ord })
      );
    }
  }
  ...
  function passes(val) {
    if (val === void 0) {
      ...
      return buildOperator4(
        Object.assign(Object.assign({}, options), { passes: val })
      );
    }
  }
...
function buildOperator5(options) {
  ...
  function layering(layer) {
    if (layer === void 0) {
      ...
      const { layering: _ } = options,
        rest = __rest4(options, ["layering"]);
  ...
  function decross(dec) {
    if (dec === void 0) {
      ...
      const { decross: _ } = options,
        rest = __rest4(options, ["decross"]);
      return buildOperator5(
  ...
  function coord(crd) {
    if (crd === void 0) {
      ...
      const { coord: _ } = options,
        rest = __rest4(options, ["coord"]);
      return buildOperator5(
  ...
  function nodeSize(sz) {
    if (sz !== void 0) {
      const { nodeSize: _, sugiNodeSize: __ } = options,
        rest = __rest4(options, ["nodeSize", "sugiNodeSize"]);
      return buildOperator5(
        Object.assign(Object.assign({}, rest), {
          nodeSize: sz,
  ...
  function sugiNodeSize(sz) {
    if (sz !== void 0) {
      const { sugiNodeSize: _, nodeSize: __ } = options,
        rest = __rest4(options, ["sugiNodeSize", "nodeSize"]);
      return buildOperator5(
        Object.assign(Object.assign({}, rest), {
          sugiNodeSize: sz,
          nodeSize: null,
...
function buildOperator7(options) {
  function coffmanGrahamCall(dag) {
    ...
    const data = new Map(
      dag.idescendants().map((node2) => [node2, { before: [], parents: [] }])
    );
...
function buildOperator8(options) {
  ...
  function large(val) {
    if (val === void 0) {
      ...
      return buildOperator8(
        Object.assign(Object.assign({}, options), { large: val })
      );
    }
  }
  optCall.large = large;
  function dist(val) {
    if (val === void 0) {
      ...
      return buildOperator8(
        Object.assign(Object.assign({}, options), { dist: val })
      );
    }
  }
  optCall.dist = dist;
...
function buildOperator10(width, height) {
  function zherebkoCall(dag) {
    ...
    for (const { source, target } of dag.ilinks()) {
      const index =
        (_a = indices2.get(source)) === null || _a === void 0
          ? void 0
          : _a.get(target);
    ...
    for (const { source, target, points } of dag.ilinks()) {
      ...
      const index =
        (_b = indices2.get(source)) === null || _b === void 0
          ? void 0
          : _b.get(target);
      if (index !== void 0) {
